...
const InvoicePrinting = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      setError('');
      const response = await axios.get(`http://localhost:3001/invoice/${partyId}`);
    ...
    <Sidebar></Sidebar>
      ...
      <div className="flex justify-between">
        ...
        {isDropdownOpen && partySuggestions.length > 0 && (
          <div className="absolute w-80 mt-16 right-60 bg-white shadow-lg border border-gray-300 rounded-md z-50">
